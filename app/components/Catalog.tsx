...
export default function Catalog() {
      ...
      item: [
        {
          ...
          price: "1000",
          itemPosition: "top-2 left-8",

          radarPosition: "top-[60%] md:top-[80%] left-[45%]", // body
        },
        {
          id: 2,
          ...
          price: "1000",
          itemPosition: "top-2 right-3",

          radarPosition: "top-[28%] md:top-[10%] left-[50%]",
        },
      ],
    },
    {
  ...
  return (
    ...
    >
      <div className="min-h-screen bg-[url(/images/bg-snow.png)] px-4 py-10 md:py-12 flex flex-col items-center gap-10">
